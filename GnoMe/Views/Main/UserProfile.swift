                                ...
                                HStack{
                                    ...
                                    VStack (alignment: .leading) {
                                        HStack (alignment: .bottom) {
                                            Text((userData.user1.FName) + (userData.user1.LName)/*(profile["name"]!) as! String*/)
                                                .font(.title)
                                                .foregroundColor(.white)
                                            Text(userData.user1.pronouns/*(profile["pronouns"]!) as! String*/)
                                                                           .foregroundColor(.white)
                                                                       
                                        }//Name and Pronouns
                                        Text("@" + (userData.user1.username)/*(profile["userName"]!) as! String)*/)
                                        Divider()
                                            .frame(height: 3)
